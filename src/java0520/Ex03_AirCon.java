...
//변수정의
	...
	//생성자 " 오버로딩" : 각각 다른 매개변수로 생성자를 여러개 만드는것
...
//	}
	//매개변수!
	Ex03_AirCon(int size){//size는 밑의 size랑 같다.
		this.size=size;// this.size는 위의 size를 가르킨다.
	}
	// 매게변수 (String company, String color)
//	Ex03_AirCon(String company, String color) {
//		this.company = company;
//		this.color =color;
	//}// 매개변수 순서만 바꿔 사용 할 수 없다.
